...
import (
	...
	mock_broker "github.com/marcioecom/payment/adapter/broker/mock"
	"github.com/marcioecom/payment/domain/entity"
	mock_repository "github.com/marcioecom/payment/domain/repository/mock"
...
func TestProcessTransaction_ExecuteInvalidCreditCard(t *testing.T) {
	...
	producerMock.EXPECT().Publish(expectedOutput, []byte(input.ID), testTopic)

	usecase := NewProcessTransaction(repositoryMock, producerMock, testTopic)
